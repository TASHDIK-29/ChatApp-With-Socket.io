...
const ChatContainer = () => {
    ...
    return selectedUser ? (
        <div className='h-[545px] flex flex-col  backdrop-blur-lg'>
            ...
            <div className='flex-1 overflow-y-auto px-4 pt-4 pb-6'>
                {
                    messages.map((msg, index) => (
                        <div key={index}
                            className={`flex items-end gap-2 ${msg.senderId === authUser._id ? 'justify-end' : 'justify-end flex-row-reverse'}`}
                        >
                            {
                                msg.image ? (
        ...
        <div className='flex flex-col items-center justify-center gap-2 text-gray-500 bg-white/10 max-md:hidden'>
            <img src={assets.logo_icon} alt="" className='max-md:hidden max-w-8' />
